  ...
  return (
    <>
      <div className="relative flex items-center justify-center">
        {isChecked && (
          <Image
            className="absolute object-cover rounded-2xl left-0 right-0 z-[-1] shadow-[#0FA9EE] shadow-xl"
            src={design2w}
            fill
            alt="design2"
          />
        ...
        <div
          className={`bg-[#F9F9FB] w-[380px] h-[500px] md:h-[550px] ${
            isChecked && "m-2"
          } rounded-2xl shadow-lg relative overflow-visible`}
        >
          <Image
          ...
          />
          {/* Text Overlay */}
          <div className="absolute inset-0 flex flex-col pt-4 px-8 text-center z-10">
            ...
            <div className="flex items-center gap-5">
              ...
              <span
                className={`${instrumentSerif.className} tracking-[-0.04em] text-black text-6xl`}
              >
                { isChecked ? "2999" : "1999" }
              </span>
            </div>
        ...
        {!isChecked && (
          <Image
            className="absolute object-cover rounded-2xl -bottom-3 -z-1"
            src={designblue}
            width={380}
            height={100}
            alt="design2"
